 ...
 */
function showSlider() {
  const slidesList = document.querySelectorAll('.about-project__slide');
  const dotsList = document.querySelectorAll('.about-project__dot');
  ...
  function activeSlide(slideIndex) {
    slidesList.forEach((slide) => {
      slide.classList.remove('about-project__slide--active');
    });

    slidesList[slideIndex].classList.add('about-project__slide--active');
  }
  ...
  function activeDot(dotIndex) {
    dotsList.forEach((dot) => {
      dot.classList.remove('about-project__dot--active');
    });

    dotsList[dotIndex].classList.add('about-project__dot--active');
  }
